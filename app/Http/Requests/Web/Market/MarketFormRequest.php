...
class MarketFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'min_trade_size' => ['required', 'numeric', 'min:0.0000000001', 'max:900000000000000000'],
            'max_trade_size' => ['required', 'numeric', 'min:0.0000000001', 'max:900000000000000000'],
            'min_trade_value' => ['required', 'numeric', 'min:0.0000000001', 'max:900000000000000000'],
            'max_trade_value' => ['required', 'numeric', 'min:0.0000000001', 'max:900000000000000000'],
            'base_ticker_size' => ['required', 'numeric', 'min:0.0000000001', 'max:900000000000000000'],
            'quote_ticker_size' => ['required', 'numeric', 'min:0.0000000001', 'max:900000000000000000'],
            'status' => ['required'],
