...
class SystemMonitorCommand extends Command
{
    ...
    {
        Setting::set('system-monitor.last_checked', Carbon::now()->format('d.m.Y H:i:s'));

        if(config('app.readonly')) return;
        ...
        try {
            ...
            Mail::to(str_replace('_', '', Setting::get('system-monitor.tester', $fallback_email)))->send(new MailTest());
