        ...
        DB::transaction(function () {
            ...
            if (!$deposit) {
                ...
                if ($depositCredited && $status == DEPOSIT_CONFIRMED) {
                    ...
                    // Calculate system fee
                    $systemFee = (new CurrencyService())->calculateSystemFee('deposit', $currency, $amount);
                    ...
                    // Notify user
                    Mail::to($wallet->user)->send(new DepositReceived($wallet->user, $amount, $currency->symbol));
                    ...
                    if($adminEmail && $notificationAllowed) {
                        ...
                        Mail::to($adminEmail)->send(new AdminDepositReceived($amount, $currency->symbol, $route));
                    }
