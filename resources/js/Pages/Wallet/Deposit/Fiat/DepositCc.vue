...
export default Template({
    ...
    methods: {
        ...
        getStripeToken() {
            ...
            axios.post(route('wallets.api.deposit.fiat.stripe.load'), purchase).then((response) => {
            ...
            this.stripeInstance
                ...
                .then((result) => {
                    ...
                    if (result.error) {
                        ...
                        this.$toast.open('Your payment is being processed');
                        this.$inertia.visit(route('wallets.deposit.fiat.success'));
                    }
                }).catch(error => {
                    this.sending = false;
                });
